...
urlpatterns = [
    ...
    # path('clean-all-participations/', clean_all_participations, name='clean_all_participations'),
...
#     path('dash_user/', dash_user, name='dash_user'),
    ...
    path('filter/', staff_filter_view, name='combined_filter_view'),
    path('hodfilter/', hod_filter_view, name='HOD_filter_view'),
